<?php
/**
 * WP_Multiple_Authors Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_wp_multiple_authors_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wp-multiple-authors.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wp_multiple_authors_plugin' );
