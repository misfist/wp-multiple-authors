module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        browserify: {
            ...
            dist: { files: { 'assets/js/wp-multiple-authors.js': 'assets/js/components/main.js' } }
        },
        uglify: {
            dist: {
                files: { 'assets/js/wp-multiple-authors.min.js': 'assets/js/wp-multiple-authors.js' },
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/wp-multiple-authors.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/wp-multiple-authors.min.css': 'assets/css/wp-multiple-authors.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/wp-multiple-authors.min.css'] }
            }
        }
    });
